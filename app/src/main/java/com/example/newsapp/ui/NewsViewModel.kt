...
class NewsViewModel(
    ...
    private fun hasInternetConnection() : Boolean{
        ...
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.M){
            val acticeNetwork = connectivityManager.activeNetwork ?: return false
            val capabailities = connectivityManager.getNetworkCapabilities(acticeNetwork) ?: return false
            return when{
                capabailities.hasTransport(TRANSPORT_WIFI) -> true
                capabailities.hasTransport(TRANSPORT_CELLULAR) -> true
                capabailities.hasTransport(TRANSPORT_ETHERNET) -> true
                else -> false
            }
        }else{
